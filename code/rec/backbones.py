"""Define all code related to backbones."""
import timm
import torch
import torch.nn as nn
from torchvision.models import detection, resnet, segmentation
...
def convert_frozen_batchnorm(module):
    """Convert frozen batchnorm."""
    bn_module = (nn.modules.batchnorm.BatchNorm2d, nn.modules.batchnorm.SyncBatchNorm)
    res = module
...
def get_backbone(backbone, pretrained=True):
    """Get a backbone based on given args."""
