...
def exp_001():
    """Define an experiment for testing purposes (refactors, etc)."""
...
def exp_006():
    """Define a same as exp_003 but using another vis pos embedding."""
    run_experiment(model_factory=lit_model_factory)
...
def exp_007():
    """Define a same as exp_004 but using another vis pos embedding."""
    run_experiment(model_factory=lit_model_factory)
...
def exp_037():
    """exp_003 but position embedding OFF, visual embedding ON."""
    run_experiment(model_factory=lit_model_factory)
